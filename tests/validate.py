...
addon = root / "TargetCopy"
toc = (addon / "TargetCopy.toc").read_text(encoding="utf-8")

required = [
    "Core.lua","Compat.lua","Modules\\Unit.lua","Modules\\Marker.lua",
    "Modules\\Macro.lua","Modules\\QuickCopy.lua","UI\\MainWindow.lua",
    "UI\\QuickCopyPopup.lua","UI\\FloatingButton.lua","UI\\Settings.lua",
